...
public class TestProgram
{
      static async Task Main()
        {
            var connStr = builder.Configuration.GetConnectionString("AnalyticsDb");

// 2) Enregistre votre DbContext pour qu’il pointe sur PostgreSQL
            ...
            var stat = await service.CalculateModuleStats(1);
